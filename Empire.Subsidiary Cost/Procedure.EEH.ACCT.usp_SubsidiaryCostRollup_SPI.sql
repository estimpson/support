...
/*
Create Procedure.EEH.ACCT.usp_SubsidiaryCostRollup_SPI.sql
*/

use EEH
go

if	objectproperty(object_id('ACCT.usp_SubsidiaryCostRollup_SPI'), 'IsProcedure') = 1 begin
	drop procedure ACCT.usp_SubsidiaryCostRollup_SPI
end
go

create procedure ACCT.usp_SubsidiaryCostRollup_SPI
...
execute
	@ProcReturn = ACCT.usp_SubsidiaryCostRollup_SPI
	@TranDT = @TranDT out

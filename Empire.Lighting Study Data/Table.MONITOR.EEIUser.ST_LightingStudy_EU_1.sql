...
/*
Create Table.MONITOR.EEIUser.ST_LightingStudy_EU_1.sql
*/
...
drop table EEIUser.ST_LightingStudy_EU_1

exec FT.sp_AddForeignKeys
*/
if	objectproperty(object_id('EEIUser.ST_LightingStudy_EU_1'), 'IsTable') is null begin
...
/*
Create trigger EEIUser.tr_ST_LightingStudy_EU_1_uRowModified on EEIUser.ST_LightingStudy_EU_1
*/

--use MONITOR
--go

if	objectproperty(object_id('EEIUser.tr_ST_LightingStudy_EU_1_uRowModified'), 'IsTrigger') = 1 begin
	drop trigger EEIUser.tr_ST_LightingStudy_EU_1_uRowModified
end
go

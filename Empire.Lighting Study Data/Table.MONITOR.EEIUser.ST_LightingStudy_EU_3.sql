...
/*
Create Table.MONITOR.EEIUser.ST_LightingStudy_EU_3.sql
*/
...
drop table EEIUser.ST_LightingStudy_EU_3

exec FT.sp_AddForeignKeys
*/
if	objectproperty(object_id('EEIUser.ST_LightingStudy_EU_3'), 'IsTable') is null begin
...
/*
Create trigger EEIUser.tr_ST_LightingStudy_EU_3_uRowModified on EEIUser.ST_LightingStudy_EU_3
*/

--use MONITOR
--go

if	objectproperty(object_id('EEIUser.tr_ST_LightingStudy_EU_3_uRowModified'), 'IsTrigger') = 1 begin
	drop trigger EEIUser.tr_ST_LightingStudy_EU_3_uRowModified
end
go
